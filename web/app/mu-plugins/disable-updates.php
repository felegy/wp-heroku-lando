 ...
 */
class OS_Disable_WordPress_Updates //phpcs:ignore
{
    /**
     ...
     * @author scripts@schloebe.de
     */
    function admin_init() { //phpcs:ignore
     ...
     * @since 1.4.4
     */
    public function block_request($pre, $args, $url) //phpcs:ignore
    {
        /* Empty url */
        if (empty($url)) {
            return $pre;
     ...
     * @since 1.5.0
     */
    public function filter_cron_events($event) //phpcs:ignore
    {
        switch ($event->hook) {
     ...
     * @since 1.6.0
     */
    public function last_checked_atm($t) //phpcs:ignore
    {
